...
export function NotificationPopover({ onNotificacaoClick, compact = false }: NotificationPopoverProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className="w-[400px] sm:w-[500px] p-0 shadow-2xl border border-border bg-popover overflow-hidden"
        align="end"
        sideOffset={12}
      >
        {/* Header — teal de marca */}
        <div className="px-6 py-4 bg-secondary text-secondary-foreground border-b border-border">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-lg font-bold leading-tight">Notificações</h4>
            ...
            {naoLidas > 0 && (
              <Button
                ...
                className="text-xs h-8 gap-1.5 text-primary hover:text-primary/80 hover:bg-primary/10"
              >
            ...
            <button
              ...
              className={cn(
                ...
                filtro === 'todas'
                  ...
                  : 'bg-background/10 text-secondary-foreground/70 hover:bg-background/20'
              )}
            >
        ...
        <ScrollArea className="h-[380px] bg-popover">
          {loading ? (

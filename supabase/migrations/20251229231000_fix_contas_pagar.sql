-- Script para corrigir/recriar tabelas de contas a pagar
-- Dropar policies existentes primeiro (se existirem)

-- Dropar policies de contas_pagar
...
-- Dropar policies de contas_pagar_colunas
...
-- Dropar policies de contas_pagar_atividades
DROP POLICY IF EXISTS "Admin pode tudo em contas_pagar_atividades" ON public.contas_pagar_atividades;
DROP POLICY IF EXISTS "Usuários podem ver contas_pagar_atividades" ON public.contas_pagar_atividades;
DROP POLICY IF EXISTS "Usuários podem criar contas_pagar_atividades" ON public.contas_pagar_atividades;
DROP POLICY IF EXISTS "Usuários podem atualizar contas_pagar_atividades" ON public.contas_pagar_atividades;
DROP POLICY IF EXISTS "Usuários podem deletar contas_pagar_atividades" ON public.contas_pagar_atividades;

-- Dropar policies de contas_pagar_movimentacoes
DROP POLICY IF EXISTS "Admin pode tudo em contas_pagar_movimentacoes" ON public.contas_pagar_movimentacoes;
DROP POLICY IF EXISTS "Usuários podem ver contas_pagar_movimentacoes" ON public.contas_pagar_movimentacoes;
DROP POLICY IF EXISTS "Usuários podem criar contas_pagar_movimentacoes" ON public.contas_pagar_movimentacoes;

-- Dropar triggers existentes
DROP TRIGGER IF EXISTS update_contas_pagar_updated_at ON public.contas_pagar;
DROP TRIGGER IF EXISTS update_contas_pagar_colunas_updated_at ON public.contas_pagar_colunas;
DROP TRIGGER IF EXISTS update_contas_pagar_atividades_updated_at ON public.contas_pagar_atividades;

...
## Repository map
- `ANALISE_COMPLETA_SISTEMA.md/` — explain what lives here and when agents should edit it.
...
- `DEPLOYMENT_FIX.md/` — explain what lives here and when agents should edit it.
- `doc/` — explain what lives here and when agents should edit it.
...
- `DOCUMENTACAO_SISTEMA_RELATORIOS.md/` — explain what lives here and when agents should edit it.
